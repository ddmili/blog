...
![项目创建](/img/png/WX20190519-230051@2x.png)

然后通过goland打开该项目：
![项目目录](/img/png/WX20190520-062806@2x.png)
...
首先我们先在创建一个数据库：
![数据库创建](/img/png/WX20190520-063304@2x.png)
...
![项目运行命令](/img/png/WX20190520-065447@2x.png)

项目启动后，监听在8080端口上。

并且执行了InitMysql()方法，初始化数据库，我们打开数据库进行刷新，已经创建好了一张数据表user：

![数据库表](/img/png/WX20190520-083914@2x.png)

打开浏览器，输入以下网址：[http://localhost:8080/register](http://localhost:8080/register) ,然后输入用户名和密码进行注册。

![注册接口调用](/img/png/WX20190520-084747@2x.png)

![数据库表数据查看](/img/png/WX20190520-084800@2x.png)
...
![用户登录](/img/png/WX20190520-090352@2x.png)

![登录成功内容提示](/img/png/WX20190520-090526@2x.png)

## 三 项目Session处理
### 3.1 Session使用场景介绍
我们希望用户登录后可以有写博客的功能，当然也允许用户退出：
![写博客功能](/img/png/WX20190521-104344@2x.png)

如果用户没有登录，直接访问首页，只可以查看文章，标签，相册等，但是没有写博客的功能：
![无权限写文章](/img/png/WX20190521-104814@2x.png)
...
#### 3.2.5 视图层开发
我们需要如下几个功能：
![导航栏](/img/png/WX20190521-111948@2x.png)
...
浏览器如下：
![浏览器效果](/img/png/WX20190521-113931@2x.png)

服务器端运行如下：
![后台程序日志](/img/png/WX20190521-114207@2x.png)

点击退出按钮，后台程序执行效果：
![退户功能日志](/img/png/WX20190521-135733@2x.png)
