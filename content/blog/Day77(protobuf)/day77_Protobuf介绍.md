...
tags = ["微服务"]
categories = ["微服务","Protobuf","工具"]
banner = "/img/png/duorenwu1_meitu_1.jpg"
description = "对于单独部署，独立运行的微服务实例而言，在业务需要时，需要与其他服务进行通信"
authors = ["韩茹"]
+++
# Protocol buffer
**@author：Davie**
...
![Protoc编译器](/img/png/WX20190605-095735@2x.png)
...
```
![protoc安装后](/img/png/protobuf.png)

安装完成以后，protoc-gen-go*可执行文件在本地环境GOPATH/bin目录下，如下图所示：
![protoc-gen-go执行文件](/img/png/WX20190604-155039@2x.png)
...
![小端位序排列的Varint编码](/img/png/121732zuyzkxzxjkwwjkx5.jpg)
...
![序列化格式](/img/png/121758l5mln3mnvpvc4mzw.jpg)
...
![wire_type类型](/img/png/WX20190606-174515@2x.png)