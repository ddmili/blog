...
description = "在前面一节课中,我们指定了consul作为微服务的注册组件"
authors = ["韩茹"]
+++
# go-micro使用(一)
**@author：Davie**
...
![consul注册与发现](/img/png/WX20190828-152536@2x.png)
...
![高耦合调用方式](/img/png/WX20190831-163801@2x.png)
...
![事件驱动](/img/png/WX20190831-170056@2x.png)
...
```
![go-plugins](/img/png/WX20190902-162841@2x.png)
...
![启动mosquitto](/img/png/WX20190903-140930@2x.png)
...
![错误](/img/png/WX20190903-113613@2x.png)
...
![server.go函数](/img/png/WX20190903-145638@2x.png)

#### 2.7.4、启动client程序
server程序启动后，启动客户端程序client.go，可以输出正确日志。另外可以在mqtt终端中输出相关的消息订阅和发布的日志，如下图所示：
![mqtt日志](/img/png/WX20190903-150034@2x.png)
