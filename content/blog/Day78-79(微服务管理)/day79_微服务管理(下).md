...
description = "服务的定义通过一个.json的json文件来进行定义，该文件中使用json格式定义所要注册服务的相关内容"
authors = ["韩茹"]
+++
# 微服务管理（下）
**@author：Davie**
...
![dns服务查询](/img/png/WX20190619-145024@2x.png)
...
![http模式查询](/img/png/WX20190619-144852@2x.png)
...
![docker版本查看](/img/png/1561086326268.jpg)
...
![docker中查找consul的镜像文件](/img/png/WX20190621-114548@2x.png)
...
![Docker安装consul环境](/img/png/WX20190621-115304@2x.png)
...
![docker中检查是否安装了consul](/img/png/WX20190621-134602@2x.png)
...
![docker中查看consul版本](/img/png/WX20190621-115457@2x.png)
...
```
![Docker启动单节点server](/img/png/WX20190711-155259@2x.png)
...
* curl访问HTTP接口：
    ...
    ![http端口的映射访问](/img/png/WX20190621-165728@2x.png)
...
![宿主机中的与docker中的节点进行交互](/img/png/WX20190621-172012@2x.png)
...
* 三个serve类型的节点集群节点：
![http://7xtcwd.com1.z0.glb.clouddn.com/WX20190712-152703@2x.png](/img/png/WX20190712-152703@2x.png)

* 所有的Node节点（server和client）：
![http://7xtcwd.com1.z0.glb.clouddn.com/WX20190712-152716@2x.png](/img/png/WX20190712-152716@2x.png)
...
均可以看到如下输出效果：
![http://7xtcwd.com1.z0.glb.clouddn.com/WX20190712-153156@2x.png](/img/png/WX20190712-153156@2x.png)
...
$docker ps
```
![http://7xtcwd.com1.z0.glb.clouddn.com/WX20190712-153542@2x.png](/img/png/WX20190712-153542@2x.png)
...
```
![http://7xtcwd.com1.z0.glb.clouddn.com/WX20190712-153839@2x.png](/img/png/WX20190712-153839@2x.png)
如果要停止多个，可以用空格隔开。
...
```
![http://7xtcwd.com1.z0.glb.clouddn.com/WX20190712-154045@2x.png](/img/png/WX20190712-154045@2x.png)
