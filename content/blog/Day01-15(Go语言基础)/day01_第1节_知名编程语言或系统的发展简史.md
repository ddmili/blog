+++
title = "知名编程语言或系统的发展简史"
date = "2022-08-01T21:29:20+02:00"
tags = ["golang"]
categories = ["golang","简史","编程"]
description = "B语言之父：Ken Thompson（肯.汤普森）。B语言是贝尔实验室开发的一种通用的程序设计语言，它是于1969年前后Ken Thompson（肯.汤普森）在Dennis Ritchie丹尼斯.里奇（Dennis Ritchie）的支持下设计出来。"
banner = "/img/png/KenThompson.jpg"
authors = ["韩茹"]
+++
...
![Ken Thompson](/img/png/KenThompson.jpg)
...
![WX20190322-173439](/img/png/WX20190322-173439.png)
...
![Bjarne Stroustrup](/img/png/BjarneStroustrup.jpg)
...
![Guido van Rossum](/img/png/GuidovanRossum.png)
...
![James Gosling](/img/png/JamesGosling.jpg)
...
![Brendan Eich](/img/png/BrendanEich.jpg)
