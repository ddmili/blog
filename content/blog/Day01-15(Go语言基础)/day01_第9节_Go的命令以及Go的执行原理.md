+++
title = "Go的执行原理以及Go的命令"
date = "2022-08-01T21:29:20+02:00"
tags = ["golang"]
categories = ["golang","简史","编程","基础"]
description = "命令源码文件被安装以后，GOPATH 如果只有一个工作区，那么相应的可执行文件会被存放当前工作区的 bin 文件夹下；如果有多个工作区，就会安装到 GOBIN 指向的目录下。"
banner = "/img/png/yuanmawenjian1.png"
authors = ["韩茹"]
+++
# Go的执行原理以及Go的命令
...
![yuanmawenjian1](/img/png/yuanmawenjian1.png)
...
![gomingling1](/img/png/gomingling1.png)
...
![gomingling2](/img/png/gomingling2.png)
...
![gomingling3](/img/png/gomingling3.png)
...
![gomingling4](/img/png/gomingling4.gif)
...
![gomingling5](/img/png/gomingling5.jpg)
...
![gomingling6](/img/png/gomingling6.png)
...
![gomingling7](/img/png/gomingling7.png)
...
![gomingling8](/img/png/gomingling8.png)
...
![gomingling9](/img/png/gomingling9.png)
...
![gomingling10](/img/png/gomingling10.jpg)



最后：

![](/img/png/zhixingyuanli.png)
...
![gomingling11](/img/png/gomingling11.jpg)
...
![gomingling14](/img/png/gomingling14.jpg)
