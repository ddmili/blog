...
description = "Go语言使用包（package）这种语法元素来组织源码，所有语法可见性均定义在package这个级别，与Java 、python等语言相比，这算不上什么创新，但与C传统的include相比，则是显得“先进”了许多。"
banner = "/img/png/20170831112523944.png"
authors = ["韩茹"]
+++
# Go语言中包的使用
...
![20170831112523944](/img/png/20170831112523944.png)
...
![anzhuangbao1](/img/png/anzhuangbao1.png)
