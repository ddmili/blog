...
description = "本规范旨在为日常Go项目开发提供一个代码的规范指导，方便团队形成一个统一的代码风格，提高代码的可读性，规范性和统一性。"
banner = "/img/png/fmtpackage.png"
authors = ["韩茹"]
+++
# 键盘输入和打印输出
...
![fmtpackage](/img/png/fmtpackage.png)
...
![bufio1](/img/png/bufio1.png)



然后就可以各种读取了：

![bufio2](/img/png/bufio2.png)
