+++
title = "第一个程序：HelloWorld"
date = "2022-08-01T21:29:20+02:00"
tags = ["golang"]
categories = ["golang","简史","编程","基础"]
description = "配置好工作目录后，就可以编码开发了，在这之前，我们看下go的通用项目结构，这里的结构主要是源代码相应地资源文件存放目录结构。"
banner = "http://7xtcwd.com1.z0.glb.clouddn.com/package1.png"
authors = ["韩茹"]
+++
# 第一个程序：HelloWorld
